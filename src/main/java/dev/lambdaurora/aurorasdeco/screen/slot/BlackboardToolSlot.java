...
public class BlackboardToolSlot extends Slot {
	public BlackboardToolSlot(Inventory inventory, int index, int x, int y) {
	...
	public boolean canInsert(ItemStack stack) {
		...
		return Blackboard.DrawAction.ACTIONS.stream()
				.filter(drawAction -> drawAction.getOffHandTool() != null)
				.anyMatch(drawAction -> drawAction.getOffHandTool() == stack.getItem());
	}
}
